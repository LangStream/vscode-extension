...
export default class WatchApplicationDeployTask implements TObservableTask<StoredApplication> {
  constructor(private readonly controlPanelName: string, private readonly tenantName: string, private readonly applicationId: string, private readonly applicationService: ApplicationService) {
  }
